...
public class InventoryManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Provides a list of item IDs for the saving system.
    /// </summary>
    public List<string> GetItemIDsForSaving()
    {
    ...
    /// <summary>
    /// Clears the current inventory and loads a new one from a list of item IDs.
    /// Note: This requires a way to find ItemData assets from an ID. A resource
    /// manager or an addressable system would be ideal. For this example, we'll
    /// use a simpler, less performant method.
    /// </summary>
    public void LoadInventoryFromIDs(List<string> itemIDs)
    {
        ...
        // After loading a whole new inventory, broadcast the change.
        OnInventoryChanged?.Invoke();
    }
