...
//    ///// </summary>
//    ///*IMPLEMENT: We want to be able to use it on the player (user)*/
//    ////TIP: Use the "override" keyword and a GameObject parameter
//    //{
//    //    // Find the health component on the user and heal them.
//    //    if (user./*IMPLEMENT: we want to Try and Get the Component PlayerHealth*/)
//    //    {
//    //        /*IMPLEMENT: once we are sure we have a user with a PlayerHealth, we call the "Heal()" method with a value*/
//    //    }
//    //}
//}
